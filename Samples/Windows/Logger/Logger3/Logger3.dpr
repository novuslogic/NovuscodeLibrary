...
uses
  ...
  NovusLogger.Provider.WinEventLog in '..\..\..\..\Source\Core\Log\NovusLogger.Provider.WinEventLog.pas',
  ...
  NovusWinEventLog in '..\..\..\..\Source\Core\Log\NovusWinEventLog.pas',
...
begin
  ...
  Try
    Log := tNovusLogger.Create([TNovusLogger_Provider_Console.Create,
              TNovusLogger_Provider_WinEventLog.Create('Logger3')]);
