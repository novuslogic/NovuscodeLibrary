...
Begin
  ...
  Case Period of
      ...
      2: Result := (((Trunc(Date1) - Trunc(Date2))* 1440) - ((Hour1 - Hour)* 60)) - (Min1 - Min);

      3: Result := ((Trunc(Date1) - Trunc(Date2))* 24) - (Hour1 - Hour);

      4: Result := Trunc(Date1) - Trunc(Date2);

      5: Result := (Trunc(Date1) - Trunc(Date2)) div 7;

      6: Result := ((Year - Year1) * 12) + (Month - Month1);
